...
export default function InputEst({placeholder, color, boolean, colorBack, keyboardType, autoCapitalize, value, onChangeText, error} : inputEst){
    ...
    <>
        ...
        {error ?
             <TextInput  onChangeText={(value) => onChangeText(value, placeholder)} value = {value} keyboardType={keyboardType} autoCapitalize={autoCapitalize}  placeholder={placeholder} placeholderTextColor={color} secureTextEntry = {boolean} style = {[styles.inputStyleError, {backgroundColor:colorBack}]} >
